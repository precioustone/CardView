 ...
 * */
package info.androidhive.cardview.helper;
...
public class SQLiteHandler extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "gasnownow_database";
	 ...
	 * */
	public void addUser(String name, String email, String uid,String address,String phone,String birth, String created_at) {
		...
		values.put(KEY_BIRTH, birth); // birthdays
	...
	public HashMap<String, String> getUserDetails() {
		...
		if (cursor.getCount() > 0) {
			...
			user.put("birthday", cursor.getString(6));
