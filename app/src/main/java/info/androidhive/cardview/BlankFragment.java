 ...
 */
public class BlankFragment extends DialogFragment implements DialogInterface.OnShowListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = i.inflate(R.layout.fragment_blank, null);
    ...
    private void startAFreshCharge(boolean local) {
        ...
        if (local) {
            ...
            charge.setAmount(Integer.parseInt(price)*100);
            ...
            new BlankFragment.fetchAccessCodeFromServer().execute(backend_url + "/new-access-code");
        }
    }
    ...
    private void chargeCard() {
        gif.setVisibility(View.VISIBLE);
        disableView();
        BlankFragment.transaction = null;
        PaystackSdk.chargeCard(getActivity(), charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                enableView();
                BlankFragment.transaction = transaction;
                mTextError.setText(" ");

                Toast.makeText(getActivity(), transaction.getReference(), Toast.LENGTH_LONG).show();
                fundWallet();
                updateTextViews();
                new BlankFragment.verifyOnServer().execute(transaction.getReference());
    ...
    private void updateTextViews() {
        if (transaction.getReference() != null) {
            mTextReference.setText(String.format("Reference: %s", msg));
        } else {
    ...
    private void fundWallet(){
        ...
        StringRequest strReqs = new StringRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                enableView();
                dismiss();
                ac.restart("Bad network, Please try again later");
            }
        }) {
